...
export default function Sidebar({ products, cartItems, handleIncrement, handleDecrement, checkoutForm, handleOnCheckoutFormChange, handleOnSubmitCheckoutForm, emailError, success, nameError }) {
